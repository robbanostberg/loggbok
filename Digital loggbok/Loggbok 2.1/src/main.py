...
import sys
import os
#import pyautogui	flyttat till gui module
...
#cid = pyautogui.prompt(text='Enter CID for mounting Z-drive', title='' , default='') ************** flyttat till GUI

# Frågar efter lösen för mount av Z-disk
#pw = pyautogui.password(text='Enter password for mounting Z-drive', title='', default='', mask='*') *********** flyttat till GUI
